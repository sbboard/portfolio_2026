...
<template>
    <footer>
        ...
        out. If I wanted to, I guess I could put something special here. Maybe a tiny easter egg or
        something. Maybe the first breadcrumb of an ARG for all you heavy readers out there who
        always scroll just a little bit farther than most people do. But for now, it's just text -
        comfortable, unbothered, doing what footers have always done: anchoring the page, adding a
        little personality, and reminding you that someone thought about the space all the way down
        here too. And honestly, that feels like a pretty good job for a footer.
    </footer>
</template>
